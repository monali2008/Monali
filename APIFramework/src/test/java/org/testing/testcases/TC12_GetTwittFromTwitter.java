...
public class TC12_GetTwittFromTwitter {
	
	@Test
	public void twelvethTestCase() throws IOException
	{
		ExtentReports extent = ExtentReportGeneration.reportGenerate();
		ExtentTest test = extent.startTest("Twelveth Test", "Get twitt with desired count");
